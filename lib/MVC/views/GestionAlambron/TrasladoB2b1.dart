...
class TrasladoB2b1View extends StatefulWidget {
  const TrasladoB2b1View({super.key});

  @override
  State<TrasladoB2b1View> createState() => _TrasladoB2b1ViewState();
}

class _TrasladoB2b1ViewState extends State<TrasladoB2b1View> {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FrontEnd.buildCard(
                            ...
                            onTap: () {
                              navigateTraslado(
                                  context, pedido, 'Bod 2 a Bod 1', 2);
                            },
                          );
                        },
                      );
