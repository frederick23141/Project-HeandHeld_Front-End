...
import 'package:handheld_beta/MVC/Views/GestionGalvanizado/TrasladarGalv.dart';
...
void navigateTrasladoGalv(BuildContext context,
    ObtenerPedidoGalvanizado Gpedido, String vistaOrigen, int bodega) {
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            if (nitEntrega == null || nitRecibe == null) {
              _showSnackbar(mGenericos.documentosNoEncontrados);
              return;
            }
